...
function createPlanets(scene) {
    ...
    const planetData = [
        { position: new THREE.Vector3(-15, 5, -5), size: 2.5, color: 0x3498db, name: "Background" },
        { position: new THREE.Vector3(0, 0, -12), size: 3, color: 0x2ecc71, name: "Motivation" },
        { position: new THREE.Vector3(12, -3, -8), size: 2, color: 0xe74c3c, name: "Bootcamp Experience" },
        { position: new THREE.Vector3(-8, -7, 2), size: 2.8, color: 0xf39c12, name: "Education at Hive" },
        { position: new THREE.Vector3(10, 8, 7), size: 2.2, color: 0x9b59b6, name: "Job Search" },
        // Additional planets
        { position: new THREE.Vector3(-5, 12, 0), size: 2.4, color: 0x1abc9c, name: "Engineering Practices" },
        { position: new THREE.Vector3(6, -9, -10), size: 3.2, color: 0xd35400, name: "Advice" },
        { position: new THREE.Vector3(-18, -4, 8), size: 2.6, color: 0x8e44ad, name: "Conclusions" }
    ];
